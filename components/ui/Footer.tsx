      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold mb-4 text-blue-400">Blog Services</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/blog/read" className="text-gray-400 hover:text-green-400 transition-colors">
                  Read Articles
                </Link>
              </li>
              <li>
                <Link href="/blog/write" className="text-gray-400 hover:text-green-400 transition-colors">
                  Write Blog
                </Link>
              </li>
              <li>
                <Link href="/blog/categories" className="text-gray-400 hover:text-green-400 transition-colors">
                  Categories
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 text-center text-gray-600 text-sm">
          © {new Date().getFullYear()} TechShelf. All rights reserved.
        </div>
      </div>
    </footer>
  );
